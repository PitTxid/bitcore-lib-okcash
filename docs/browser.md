...
<head>
  <meta charset="utf-8">
  <script src="bower_components/bitcore/bitcore-lib-okcash.min.js"></script>
...
```sh
browserify --require ./index.js:bitcore-lib-okcash | uglifyjs > bitcore-lib-okcash.min.js
```

```sh
browserify --require ./index.js:bitcore-mnemonic --external bitcore-lib-okcash | uglifyjs > bitcore-mnemonic.min.js
```
